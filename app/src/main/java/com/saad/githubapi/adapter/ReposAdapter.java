package com.saad.githubapi.adapter;
...
import com.saad.githubapi.R;
import com.saad.githubapi.model.GitHubRepo;
...
public class ReposAdapter extends RecyclerView.Adapter<ReposAdapter.ReposViewHolder>  {
    ...
    public static class ReposViewHolder extends RecyclerView.ViewHolder {
        ...
        public ReposViewHolder(View view) {
            super(view);
            reposLayout =  view.findViewById(R.id.repo_item_layout);
